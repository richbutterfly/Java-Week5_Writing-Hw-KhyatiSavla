...
public class Programme_10_TubeLine {
    ...
    public static void main(String[] args) {
        //List of all station in Zone 1 in London
        String[] tubeStationZone1 = new String[]{"Aldgate", "Aldegate East", "Angel", "Baker Street", "Bank", "Barbican", "Bayswater", "Blackfriars", "Bond Street", "Borough", "CannonStreet", "Chancery Lane", "Charing cross", "Covent Garden", "Earl's Court", "Edgeware Road", "Elephant & Castle", "Embankment", "Euston", "Euston Square", "Farringdon", "Gloucester Road",
                "Goodge Street", "Great Portland Street", "Green Park", "High Street Kensington", "Holborn", "Hyde Park Corner", "King's Cross", "Knightsbridge", "Lambeth North", "Lancaster Gate", "Leicester Square", "Liverpool Street", "London Bridge", "Mansion House",
                "Marble Arch", "Marylebone", "Monument", "Moorgate", "Notting Hill Gate", "Old Street", "Oxford Circus", "Paddington", "Piccadilly Circus", "Pimlico", "Queensway", "Regent's Park", "Russell Square", "Sloane Square",
                "South Kensington", "St Pancras", "St. Paul's", "Temple", "Tottenham Court Road", "Tower Gateway", "Tower Hill", "Vauxhall", "Victoria", "Warren Street", "Waterloo East", "Waterloo", "Westminster"};
        ...
        londonUGLines[1][13] = "Oxfords Circus";
        ...
        londonUGLines[2][21] = "St Pancreas";
        ...
        londonUGLines[4][7] = "King's ross";
        londonUGLines[4][8] = "Great Portland Street";
        londonUGLines[4][9] = "St Pancreas";
        ...
        londonUGLines[6][10] = "St.Pancreas";
        ...
        londonUGLines[7][13] = "St.Pancreas";
